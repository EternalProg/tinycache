...
void BM_ReadHeavy_Uniform_Small(benchmark::State& state) {
...
void BM_ReadHeavy_Zipf_Small(benchmark::State& state) {
  WorkloadConfig config{/*cache_capacity=*/4096,
                        /*working_set=*/2048,
                        /*prefill=*/2048,
                        /*value_size=*/256,
...
void BM_ReadHeavy_Uniform_Pressure(benchmark::State& state) {
  WorkloadConfig config{/*cache_capacity=*/4096,
                        /*working_set=*/12288,
                        /*prefill=*/4096,
                        /*value_size=*/256,
...
void BM_ReadHeavy_Zipf_Pressure(benchmark::State& state) {
  WorkloadConfig config{/*cache_capacity=*/4096,
                        /*working_set=*/12288,
                        /*prefill=*/4096,
                        /*value_size=*/256,
...
BENCHMARK(BM_ReadHeavy_Uniform_Small)
    ->MinTime(0.1)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK(BM_ReadHeavy_Zipf_Small)->MinTime(0.1)->Unit(benchmark::kMicrosecond);
BENCHMARK(BM_ReadHeavy_Uniform_Pressure)
    ->MinTime(0.1)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK(BM_ReadHeavy_Zipf_Pressure)
    ->MinTime(0.1)
    ->Unit(benchmark::kMicrosecond);
