...
void BM_Balanced_Uniform_Small(benchmark::State& state) {
...
void BM_Balanced_Zipf_Small(benchmark::State& state) {
  WorkloadConfig config{/*cache_capacity=*/4096,
                        /*working_set=*/2048,
                        /*prefill=*/2048,
                        /*value_size=*/256,
...
BENCHMARK(BM_Balanced_Uniform_Small)
    ->MinTime(0.1)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK(BM_Balanced_Zipf_Small)->MinTime(0.1)->Unit(benchmark::kMicrosecond);
